...
root.geometry('1180x980+0+0')
root.resizable(0,0)
root.title('Miras Record Room')
...
clock()
s='Miras Record Room' #s[count]=t when count is 1
...
addsButton=ttk.Button(root,text='Assignment',command=lambda: subprocess.Popen(args=['python', r'F:\Project23\Student\assign.py']))
addsButton.place(x=800,y=40)
connButton=ttk.Button(root,text='Attendence',command=lambda: subprocess.Popen(args=['python', r'F:\Project23\Student\attend.py']))
connButton.place(x=800,y=0)
coButton=ttk.Button(root,text='Topic Update',command=lambda: subprocess.Popen(args=['python', r'F:\Project23\Student\teach.py']))
coButton.place(x=980,y=40)

leftFrame=Frame(root)
leftFrame.place(x=50,y=80,width=500,height=600)

logo_image=PhotoImage(file='stu.png')
...
style.configure('Treeview', rowheight=40,font=('arial', 12, 'bold'), fieldbackground='wheat', background='linen',)
style.configure('Treeview.Heading',font=('arial', 14, 'bold'),foreground='gold1')
